  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 mb-8">Paste your resume and job description — AI will score your match instantly</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h3 className="font-semibold text-gray-700 mb-3">📄 Your Resume</h3>
            <textarea
              rows={12}
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {result.missingKeywords?.map((kw, i) => (
                    <span key={i} className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-sm font-medium">
                      {kw}
                    </span>
                  ))}
                </div>
